...
Info  : https://brightdata.jp/products/insights/price-tracker/aldi
"""
...
# https://brightdata.jp/products/web-scraper/aldi
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Aldi scraper at: https://brightdata.jp/products/web-scraper/aldi\n"
